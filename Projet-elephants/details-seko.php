...
<br>
<p class="description">Seko Fofana, né le 7 mai 1995 à Paris est un <br> footballeur international ivoirien qui évolue au poste <br> de milieu de terrain à Al-Ettifaq FC, prêté par Al-Nassr FC.</p>
<br>
<br>
<p class="description">
    Seko Fofana a été décisif pour la Côte d'Ivoire à la CAN 2024  <br>
     marquant dès le match d'ouverture,assurant la qualification en <br>
      demi-finale grâce à ses buts.Son retour en sélection a renforcé <br>
       l'équipe et inspiré ses coéquipiers.Sa performance a été largement <br>
       saluée par les supporters et les médias. Fofana a joué un rôle essentiel <br>
  ...
  <swiper-container class="mySwiper" slides-per-view="3" centered-slides="true" space-between="30" pagination="true"
      ...
      <swiper-slide>
          <a href="img/seko1.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
              <img style="max-width: 300px; height:300px"  src="img/seko1.jpg" alt="">
          </a>
      ...
      <swiper-slide>
          <a href="img/seko2.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
              <img style="max-width: 300px; height:300px" src="img/seko2.jpg" alt="">
          </a>
      ...
      <swiper-slide>
          <a href="img/seko3.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
              <img style="max-width: 300px; height:300px"  src="img/seko3.jpg" alt="">
          </a>
      ...
      <swiper-slide>
          <a href="img/seko4.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
              <img style="max-width: 300px; height:300px"  src="img/seko4.jpg" alt="">
          </a>
      ...
      <swiper-slide>
          <a href="img/seko5.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
              <img style="max-width: 300px; height:300px"  src="img/seko5.jpg" alt="">
          </a>
      ...
      <swiper-slide>
          <a href="img/seko6.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
              <img style="max-width: 300px; height:300px"  src="img/seko6.jpg" alt="">
          </a>
