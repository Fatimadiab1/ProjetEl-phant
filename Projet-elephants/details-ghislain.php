...
<!-- Carouselle -->
 <div class="fourthsection-player">
  <swiper-container class="mySwiper" slides-per-view="3" centered-slides="true" space-between="30" pagination="true"
      ...
      <swiper-slide>
          <a href="img/konan1.jpeg" data-fancybox data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/konan2.jpeg" data-fancybox data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/konan3.jpeg" data-fancybox data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/konan5.jpeg" data-fancybox data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/konan6.jpeg" data-fancybox data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/konan7.jpeg" data-fancybox data-caption="Can 2023 // Ivoirien">
