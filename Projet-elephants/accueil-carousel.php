  ...
  <swiper-container class="mySwiper" slides-per-view="3" centered-slides="true" space-between="30" pagination="true"
      ...
      <swiper-slide>
          <a href="img/elephants1.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/elephants2.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/elephants3.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/elephants4.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/elephants5.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
      ...
      <swiper-slide>
          <a href="img/elephants6.jpg" data-fancybox = "gallery"data-caption="Can 2023 // Ivoirien">
